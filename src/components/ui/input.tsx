    ...
    return (
      <input
        ...
        className={cn(
          ...
          "dark:bg-secondary dark:border-border dark:text-foreground dark:placeholder:text-muted-foreground dark:focus-visible:ring-brand dark:focus-visible:border-brand",
          className,
        )}
        ref={ref}
        {...props}
